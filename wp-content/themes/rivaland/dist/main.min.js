...
/* harmony import */ var aos_dist_aos_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! aos/dist/aos.js */ "./node_modules/aos/dist/aos.js");
/* harmony import */ var aos_dist_aos_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(aos_dist_aos_js__WEBPACK_IMPORTED_MODULE_2__);
...
gsap__WEBPACK_IMPORTED_MODULE_4__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_5__.ScrollTrigger, gsap_SplitText__WEBPACK_IMPORTED_MODULE_6__.SplitText);
(function (window, document, $, undefined) {
  ...
  var Base = function () {
    ...
    var ready = function ready() {
      ...
      aos_dist_aos_js__WEBPACK_IMPORTED_MODULE_2__.init();
    ...
    var smoothScrolling = function smoothScrolling() {
      var lenis = new lenis__WEBPACK_IMPORTED_MODULE_7__["default"]();
     ...
     */
    var accordionJS = function accordionJS() {
      var block = $('.accordions-wrapper');
      if (block.length) {
        var headings = block.find('.accordion-heading');
        var contents = block.find('.accordion-content');
      ...
      var observer = new IntersectionObserver(function (entries, observer) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            ...
            var rawStat = $this.data("stat"); // Get raw data-stat value
            ...
            var match = rawStat.match(/^([^0-9\-]*)?([\d,\.]+)(.*)?$/);
            if (!match || !match[2]) {
              console.error("Invalid data-stat format:", rawStat);
              return;
            }
            var prefix = match[1] || ""; // Optional Prefix
            var number = parseFloat(match[2].replace(/,/g, "")); // Numeric value
            var suffix = match[3] || ""; // Optional Suffix
            ...
            // Initialize CountUp
            var counter = new countup_js__WEBPACK_IMPORTED_MODULE_3__.CountUp(entry.target, number, options);
            if (!counter.error) {
              counter.start();
            } else {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunktailwind_href_starter_theme"] = self["webpackChunktailwind_href_starter_theme"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["dist/main.min","dist/editor-styles.min"], () => (__webpack_require__("./js/main.js")))
/******/ 	__webpack_require__.O(undefined, ["dist/main.min","dist/editor-styles.min"], () => (__webpack_require__("./scss/main.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/main.min","dist/editor-styles.min"], () => (__webpack_require__("./scss/_editor-styles.scss")))
